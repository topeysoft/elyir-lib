 ...
 * Command: /mongoose-os/fw/tools/gen_sys_config.py --c_name=mgos_ro_vars --c_global_name=mgos_sys_ro_vars --dest_dir=/Volumes/Dev/git/elyir-fw/toggle-switch/deps/elyir/build/gen/ /mongoose-os/fw/src/mgos_ro_vars_schema.yaml
 */
