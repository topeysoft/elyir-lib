 ...
 * Command: /mongoose-os/fw/tools/gen_sys_config.py --c_name=mgos_config --c_global_name=mgos_sys_config --dest_dir=/Volumes/Dev/git/elyir-fw/toggle-switch/deps/elyir/build/gen/ /mongoose-os/fw/src/mgos_debug_udp_config.yaml /mongoose-os/fw/src/mgos_sntp_config.yaml /mongoose-os/fw/platforms/esp8266/src/esp_mbedtls_config.yaml /mongoose-os/fw/src/mgos_sys_config.yaml /mongoose-os/fw/platforms/esp8266/src/esp_sys_config.yaml /Volumes/Dev/git/elyir-fw/toggle-switch/deps/elyir/build/gen/mos_conf_schema.yml
 */
...
static inline const char *mgos_sys_config_get_mqtt_base(void) { return mgos_config_get_mqtt_base(&mgos_sys_config); }
...
static inline const char *mgos_sys_config_get_mqtt_broadcast(void) { return mgos_config_get_mqtt_broadcast(&mgos_sys_config); }
...
static inline void mgos_sys_config_set_mqtt_base(const char *val) { mgos_config_set_mqtt_base(&mgos_sys_config, val); }
static inline void mgos_sys_config_set_mqtt_pub(const char *val) { mgos_config_set_mqtt_pub(&mgos_sys_config, val); }
static inline void mgos_sys_config_set_mqtt_sub(const char *val) { mgos_config_set_mqtt_sub(&mgos_sys_config, val); }
static inline void mgos_sys_config_set_mqtt_broadcast(const char *val) { mgos_config_set_mqtt_broadcast(&mgos_sys_config, val); }
